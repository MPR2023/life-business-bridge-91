  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto py-12 space-y-8">
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-16 gold-gradient">AI Implementations</h1>
        {posts.length > 0 ? (
          <div className="grid gap-6 md:grid-cols-2">
            {posts.map(({ slug, title }) => (
              <Link
                key={slug}
                to={`/blog/ai-implementations/${slug}`}
...
export default AIImplementationsIndex;
